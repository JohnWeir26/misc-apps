...
window.title("JohnDex")
window.config(padx=10, pady=10)

title_label = tk.Label(window, text="JohnDex")
...
#function to load pokemon images
...
btn_load = tk.Button(window, text="Load A Pokemon, slut!", command=load_pokemon)
btn_load.config(font=('Arial', 12))
